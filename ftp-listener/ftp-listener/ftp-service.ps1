...
public class FTPService {
    ...
    public static void Main() {
        try {
            Console.WriteLine("Starting FTP Listener Service...");
            string jarPath = @".\ftp-listener-0.0.1-SNAPSHOT.jar";
            ...
            int port = FindAvailablePort(8086);
            ...
            Console.WriteLine("FTP Listener Service is starting on port " + port + "...");
            ...
            Console.WriteLine("Error starting FTP service: " + ex.Message);
...
Add-Type -TypeDefinition $code -OutputAssembly "ftp-service.exe" -OutputType ConsoleApplication
